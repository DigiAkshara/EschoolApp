    ...
    <tbody className="divide-y divide-gray-200 bg-white z-1">
      {studentFees.map((studentFee, index) => (
        <tr key={studentFee.studentId} className="bg-gray-50">
          ...
          <td className="whitespace-nowrap py-2 pl-2 pr-3 text-sm sm:pl-0">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <div className="mt-1 text-gray-500">{studentFee.admissionNo}</div>
              </div>
            </div>
          </td>
          ...
          <td className="whitespace-nowrap px-2 py-2 text-sm text-gray-500">
            {studentFee.fees.reduce((acc, fee) => acc + fee.amount, 0)}
          </td>
          <td className="whitespace-nowrap px-2 py-2 text-sm text-gray-500">
            {studentFee.fees
          ...
          <td className="whitespace-nowrap px-2 py-2 text-sm text-gray-500">
            {studentFee.fees.every((fee) => fee.paymentStatus === "paid")
              ? "Paid"
              : "Pending"}
          </td>
          <td className="whitespace-nowrap px-2 py-2 text-sm text-gray-500">
