...
const stats = [
  { id: 1, name: 'Total Students', stat: '71,897', icon: UsersIcon, change: '122', changeType: 'increase' },
  { id: 2, name: 'Total Staff', stat: '2400', icon: UserGroupIcon, change: '5.4%', changeType: 'increase' },
  { id: 3, name: 'Total Fee Collection', stat: '18000', icon: CurrencyRupeeIcon, change: '3.2%', changeType: 'decrease' },
  { id: 3, name: 'Expenses', stat: '60000', icon: DocumentCurrencyRupeeIcon, change: '3.2%', changeType: 'decrease' },
]

const qucickactions = [
    { id: 1, name: 'Add New Student', icon: UserPlusIcon},
    { id: 2, name: 'Add New Staff', icon: UserPlusIcon },
    { id: 3, name: 'Add Attendance', icon: ClipboardDocumentCheckIcon},
    { id: 4, name: 'View Exam Results', icon: EyeIcon},
    { id: 5, name: 'Add Exam Results', icon: DocumentPlusIcon},
    { id: 6, name: 'Collect Fee', icon: UserGroupIcon },
    { id: 7, name: 'Add Expences & Staff Loans', icon: CurrencyRupeeIcon},
    { id: 8, name: 'Send SMS', icon: DocumentCurrencyRupeeIcon},
    { id: 9, name: 'Daily Report', icon: DocumentCurrencyRupeeIcon},
    { id: 10, name: 'Classes', icon: DocumentCurrencyRupeeIcon},
  ]
              ...
              >
                <dt>
                  <div className="absolute rounded-md bg-orange-50 p-3">
                    <item.icon aria-hidden="true" className="size-6 text-orange-800" />
                  </div>
