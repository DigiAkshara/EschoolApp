      ...
      if (response.data?.data?.length > 0) {
        ...
        if (firstSectionId) {
          const filteredStudents = students?.filter(
            (student) =>
              student.classId === classId && student.sectionId === firstSectionId
          );
                          ...
                          return (
                            ...
                            >
                              ...
                              >
                                ...
                                {openMenuDay === dayObj.day && ["P", "A", "F"].includes(attendanceValue) && (
                                      ...
                                      <MenuItem>
                                        <div className="flex p-4">
                                          ...
                                          <button
                                            type="button"
                                            onClick={() =>
                                              handleSave(dayObj.day, student.id)
                                            }
