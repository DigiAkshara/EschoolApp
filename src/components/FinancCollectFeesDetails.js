                                  ...
                                  <table className="min-w-full table-fixed divide-y divide-gray-300 border border-gray-300 rounded-md">
                                    ...
                                    <tbody className="divide-y divide-gray-200 bg-white">
                                        <tr>
                                          ...
                                          <td className="whitespace-nowrap px-2 py-2 text-sm text-gray-500">2 Installments</td>
                                          <td className="whitespace-nowrap px-2 py-2 text-sm text-gray-500">1000</td>
                                          <td className="whitespace-nowrap px-2 py-2 text-sm text-gray-500">0</td>
                                          <td className="whitespace-nowrap px-2 py-2 text-sm text-gray-500">500</td>
                                          <td className="whitespace-nowrap px-2 py-2 text-sm text-gray-500">500</td>
                                        ...
                                        <tr>
                                          ...
                                          <td className="whitespace-nowrap px-2 py-2 text-sm text-gray-500">Book Fee</td>
                                          <td className="whitespace-nowrap px-2 py-2 text-sm text-gray-500">One TIme</td>
                                          <td className="whitespace-nowrap px-2 py-2 text-sm text-gray-500">1000</td>
                                          <td className="whitespace-nowrap px-2 py-2 text-sm text-gray-500">200 Discount</td>
                                          <td className="whitespace-nowrap px-2 py-2 text-sm text-gray-500">800</td>
                                          <td className="whitespace-nowrap px-2 py-2 text-sm text-gray-500">0</td>
                                        ...
                                        <tr>
                                          ...
                                          <td className="whitespace-nowrap px-2 py-2 text-sm text-gray-500">Tution Fee</td>
                                          <td className="whitespace-nowrap px-2 py-2 text-sm text-gray-500">2 Installments</td>
                                          <td className="whitespace-nowrap px-2 py-2 text-sm text-gray-500">1000</td>
                                          <td className="whitespace-nowrap px-2 py-2 text-sm text-gray-500">0</td>
                                          <td className="whitespace-nowrap px-2 py-2 text-sm text-gray-500">500</td>
