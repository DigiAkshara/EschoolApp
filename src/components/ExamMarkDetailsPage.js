...
import { ArrowsUpDownIcon, DocumentArrowDownIcon, EyeIcon, XMarkIcon } from "@heroicons/react/24/outline";
...
function ExamMarkDetailsPage({ onClose }) {
  ...
  <tbody className="divide-y divide-gray-200 bg-white z-1">
    {tableData.map((student, index) => (
      <tr key={index}>
        <td className="px-2 py-2 text-sm">{student.rollNo}</td>
  ...
  className="size-9 rounded-full" />
                          ...
                          <div className="ml-4">
                            <div className="font-medium text-gray-900 text-purple-600">{student.name}</div>
        ...
        <td className="px-2 py-2 text-sm">{student.english}</td>
        <td className="px-2 py-2 text-sm">{student.telugu}</td>
        <td className="px-2 py-2 text-sm">{student.maths}</td>
        <td className="px-2 py-2 text-sm">{student.social}</td>
        <td className="px-2 py-2 text-sm">{student.science}</td>
        <td className="px-2 py-2 text-sm">{student.hindi}</td>
        <td className="px-2 py-2 text-sm">{student.marksObtained}</td>
        <td className="px-2 py-2 text-sm">{student.maxMarks}</td>
        <td className="px-2 py-2 text-sm">{student.percentage}</td>
        <td className="px-2 py-2 text-sm">
          <span
            className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${
              student.result === "Pass" ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"
            }`}
          >
            {student.result}
          </span>
