...
const navigation = [
  ...
  { name: 'Admin Operations', href: '#', icon: ChartPieIcon, current: false },
  { name: 'Notice Board', href: '#', icon: ChartPieIcon, current: false },
]
const teams = [
...
export default function Allcode({sidebarOpen,updateSideBar }) {
            ...
            >
              <TransitionChild>
                <div className="absolute left-full top-0 flex w-16 justify-center pt-5 duration-300 ease-in-out data-[closed]:opacity-0">
                  <button type="button" onClick={() => updateSideBar(false)} className="-m-2.5 p-2.5">
              ...
              <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-purple-100 px-6 pb-4">
                ...
                <nav className="flex flex-1 flex-col">
                  <ul role="list" className="flex flex-1 flex-col gap-y-7">
                    ...
                    <li>
                      <div className="text-xs/6 font-semibold text-purple-200">Your teams</div>
